...
| Consulting public-site fix/readiness pass | `consulting` | done | Kaizen `kzn-20260505-consulting-site-needs-a-focused-fi-c331c1f6`, consulting PR #3, live-intake receipt | archive/dashboard | Superseded the initial active snapshot after the readiness pass merged and the live intake smoke was recorded. |
| DeMario launch-feedback social/proof packet | `demario-pickleball-1` | done | Kaizen `kzn-20260505-demario-pickleball-site-is-live-an-29574ac8`, proof queue, public post URLs | archive/proof queue | Superseded the initial active snapshot after Toni posted and provided exact LinkedIn/Instagram URLs. |
| Omnexus subscription-review resubmission | `fitness-app` | waiting | Kaizen `kzn-20260505-omnexus-is-approved-on-the-app-sto-4db279d0`, Omnexus App Store docs | waiting/repo health | Updated from active to waiting after app version `1.0.1` reached `Pending Developer Release` while monthly/annual subscriptions remained `Waiting for Review`. |
| Architected Strength public-signal finish/fix | `architected-strength` | done | Kaizen `kzn-20260505-architected-strength-should-be-reo-a3606e84`, PR #3, `docs/roadmap/kanban-board.md` | archive plus local Kanban | Superseded the initial active snapshot after PR #3 merged the P0/P1 public-signal finish pass. |
