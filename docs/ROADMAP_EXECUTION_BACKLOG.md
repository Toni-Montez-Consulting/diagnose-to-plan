...
| Prospect follow-up drafting kit | `diagnose-to-plan` | Done | follow-up playbook plus Diagnostic Call, paid-Blueprint, and park/decline templates exist with send, pricing, proof, calendar, and data gates intact | use only after prospect-intake triage; public booking link can appear after submission when configured; no direct event creation, pricing, or send action without Toni approval |
