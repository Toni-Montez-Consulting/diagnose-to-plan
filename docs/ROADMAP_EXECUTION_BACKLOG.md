...
| Client recap/action-plan closeout | private `engagements`, sanitized DTP | Active next | Cam and Greg May 15 recap/action-plan drafts exist in private kits and no public proof/client send occurred | Toni reviews drafts, then explicitly approves send, revise, Gmail draft creation, or hold |
