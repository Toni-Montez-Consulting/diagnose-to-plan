...
| Practice public offer sequence | `diagnose-to-plan`, later `consulting` | Done | `docs/PRACTICE_PUBLIC_OFFER_SEQUENCE.md` chooses Launch / Proof first, AI Workflow Implementation second, and Client OS / Command Room third for the next public positioning pass | use before editing public offer hierarchy |
