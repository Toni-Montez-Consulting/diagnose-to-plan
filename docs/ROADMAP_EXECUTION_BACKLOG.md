...
| Prospect follow-up drafting kit | `diagnose-to-plan` | Done | follow-up playbook plus fit-call, paid-Blueprint, and park/decline templates exist with send, pricing, proof, calendar, and data gates intact | use only after prospect-intake triage; no send, pricing, or calendar action without Toni approval |
