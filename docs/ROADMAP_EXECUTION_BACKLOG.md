...
| Greg BOS first domain audit | private `engagements`, sanitized DTP | Review | private Greg BOS audit and sanitized steward receipt exist without client send, ad account, budget, connector, public proof, live system, Hub, Notion, or QuickBooks movement | Toni decides whether to create a Greg paid-social readiness packet, revise/create/send the recap draft, or hold |
...
| Campaign Ops advertising wedge | `diagnose-to-plan`, private Greg lane | Review | Motion/Meta source-backed research frames Campaign Ops as offer/landing-page/creative/testing/tracking/CRM/follow-up workflow, not ad agency, ROAS guarantee, or automated ad publishing; Greg BOS audit confirms the next artifact should be a paid-social readiness packet | create the Greg readiness packet only if Toni approves continuing the lane; no ad account, budget, or public copy movement |
