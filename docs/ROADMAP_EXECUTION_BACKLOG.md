...
| Pattern Intelligence research-to-offer loop | `diagnose-to-plan` | Ready | one reviewed company-pattern study produces a diagnostic question, artifact candidate, evidence limit, and parked idea | start with Glean because Business Memory OS already has a diagnostic artifact |
