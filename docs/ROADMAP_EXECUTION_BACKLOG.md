...
| Pattern Intelligence research-to-offer loop | `diagnose-to-plan` | Review | first Glean company-pattern study exists and needs Toni review before template, public copy, or automation expansion | review `practice-os/research/pattern-candidates/2026-05-15-glean-business-memory-company-pattern-study.md` |
