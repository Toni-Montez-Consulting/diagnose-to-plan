...
- AI Operating Loop readiness uses `practice-os/templates/ai-operating-loop-readiness-review.md` before AI governance, clear-lane, human-in-the-loop, model orchestration, or AI-infrastructure ideas become public copy, compliance language, connectors, runtime work, source-pack automation, FAOS, or autonomy expansion.
- Business Admin OS uses `docs/BUSINESS_ADMIN_OPERATING_SYSTEM.md`, `practice-os/templates/business-admin-item.md`, `practice-os/templates/calendar-policy.md`, and `practice-os/templates/apple-reminders-capture-pilot.md` before Google Workspace, Calendar/Meet, Apple Reminders capture, LLC readiness, EIN/banking/tax, contracts, insurance, or brand/admin overhead becomes live process. Business Operating System coverage uses `docs/BUSINESS_OPERATING_SYSTEM_COVERAGE_MAP.md` and `practice-os/templates/business-operating-system-domain-audit.md` before claiming Toni's practice or a client business has complete operating coverage across marketing, sales, finance, delivery, support, legal/risk, people/vendor, reporting, launch, or domain-specific operations. The internal offer repertoire uses `docs/INTERNAL_OFFER_REPERTOIRE_CATALOG.md` and `practice-os/templates/offer-catalog-item.md` before new delivery patterns become public offers.
...
| Research Radar first item | `diagnose-to-plan` | Done | `practice-os/research/radar/2026-05-15-pattern-intelligence-ai-company-patterns.md` classifies Pattern Intelligence as Pilot with source and next action | run one manual company-pattern study before template or automation expansion |
| Pattern Intelligence research-to-offer loop | `diagnose-to-plan` | Review | first Glean company-pattern study exists and needs Toni review before template, public copy, or automation expansion | review the Glean study plus the Business Memory diagnostic proof review before more company studies |
...
| May 2026 Client OS pilot wave | private `engagements`, sanitized DTP | Active next | Greg, CCAAP, and Cam each get a packet/receipt or an explicit waiting-state record without public proof leakage; Cam's first private Ridgewell mock-data visual prototype is merged in PR #1 | review the private Ridgewell prototype locally, keep Cameron access/public proof blocked, and keep CCAAP in the existing packet lane until reopened |
...
| Business Operating System coverage map | `diagnose-to-plan` | Review | internal coverage map, reusable domain-audit template, and current-system steward audit exist without public copy, software, hosted DTP, Notion, Hub, QuickBooks, connector, or automation movement | apply the template to Greg, Cam, CCAAP, or Omnexus before promoting a checklist, command, dashboard, or public offer component |
| Greg BOS first domain audit | private `engagements`, sanitized DTP | Review | private Greg BOS audit, private paid-social readiness packet, and sanitized steward receipts exist without client send, ad account, budget, connector, public proof, live system, Hub, Notion, or QuickBooks movement | Toni reviews the private readiness packet and recap/action-plan draft, then explicitly approves a sendable packet, revise, Gmail draft creation, send, or hold |
| DTP client delivery engine correction | `diagnose-to-plan`, `consulting`, private `engagements` | Done | durable memory, consulting instructions, External Communications correction, DTP delivery templates, source pack, and steward audit now require meeting-note consumption, relationship tone, packet attachment, Gmail draft receipt, and send/hold status | use the Client Delivery Gate on the next Greg, Cam, CCAAP, or owner follow-up before calling a draft ready |
...
| Client recap/action-plan closeout | private `engagements`, sanitized DTP | Active next | Greg and Cam now have review-only Gmail packet drafts with attachment/source records, Cam/Greg meeting notes are represented in decision context, Ridgewell PR #1 is merged privately, and no public proof/client send occurred | Toni reviews the attached Gmail drafts, then explicitly approves revise, send, or hold; future follow-ups must pass the Client Delivery Gate before being called ready |
| Campaign Ops advertising wedge | `diagnose-to-plan`, private Greg lane | Review | Motion/Meta source-backed research frames Campaign Ops as offer/landing-page/creative/testing/tracking/CRM/follow-up workflow, not ad agency, ROAS guarantee, or automated ad publishing; a private Greg readiness packet now tests the lane against source, funnel, support, activation, and weekly decision gates | Toni reviews whether the Greg packet is useful before promoting any reusable checklist, public offer language, ad account, budget, or automation movement |
| AI Governance Operating Loop lane | `diagnose-to-plan` | Review | MDASH-inspired internal pattern candidate, AI Operating Loop Readiness Review template, private Greg and Cam proof passes, steward receipts, and routing docs exist without public copy, compliance advice, runtime, connectors, FAOS, source-pack automation, or autonomy expansion | Apply the readiness review to DTP delivery, or have Toni review both proof passes, before promoting a checklist, proposal section, offer language, or implementation lane |
| Business Memory OS diagnostic proof lane | `diagnose-to-plan` | Review | Northline diagnostic review and Omnexus known-business diagnostic fixture exist without public copy, software, private data, runtime, or `tm-skills` movement | Toni reviews both diagnostic fixtures; create a lightweight review pattern only if they feel specific |
