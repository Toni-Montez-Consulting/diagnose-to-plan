...
- `decisions/0020-qa-audit-source-pack.md`: accepted decision for promoting
  QA / Audit into the source-pack file after its evidence-to-claim
  source-policy pilot.
...
- `docs/SOFTWARE_ENGINEERING_SOURCE_POLICY_PILOT_2026-05-10.md`: internal
  ...
  gates.
- `docs/QA_AUDIT_SOURCE_POLICY_PILOT_2026-05-10.md`: internal QA / Audit pilot
  for evidence-to-claim matching, manual gates, go/no-go language, residual
  risk, source posture, and approval boundaries.
- `docs/DEVOPS_INFRASTRUCTURE_SOURCE_POLICY_PILOT_2026-05-10.md`: internal
  DevOps / Infrastructure pilot for deployment readiness, runtime proof,
  environment inventory, rollback, observability, cost/risk posture, secret
...
- `docs/LIVE_INTAKE_TO_PRACTICE_OS_WORKFLOW_V0.md`: operating pattern for turning a live `tonimontez.co/start` submission in Hub into a DTP triage decision, offer route, next artifact, approval gate, and handoff receipt.
...
- `docs/PORTFOLIO_IDEA_RECOVERY_SWEEP_V0.md`: DTP-owned recovery ledger for missed or under-captured ideas, product lanes, preferences, and agent rules across the portfolio. Treats old chats and recovery outputs as leads, keeps raw transcript text out of tracked docs, uses ignored `outputs/` packets for fuller local context, and promotes only reviewed rows into Kaizen, roadmap, pattern, skill, repo-instruction, or private-vault destinations.
...
- Use `docs/CONSULTING_WORKSPACE_OS_V0.md`,
  `practice-os/templates/requirements-gathering-brief.md`, and
  `practice-os/templates/requirements-decision-ledger.md` when a request needs
  systematic requirements gathering, risk-sized discovery, deeper question
  batches, or a build-ready brief before implementation.
- Use `practice-os/policies/integrity-layer-craft-standard.md` and
