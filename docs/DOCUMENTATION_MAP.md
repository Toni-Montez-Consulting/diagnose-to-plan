...
- `docs/AGENT_SQUADS_KNOWLEDGE_BASE_V0.md`: DTP-owned operating model for
  ...
  receipts, consulting proof/offer pilot routing, and future hosted DTP squad
  records. External Squad/SuperClaude-style frameworks stay inspiration-only.
