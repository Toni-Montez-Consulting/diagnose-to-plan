...
| Business Pattern Steward / Business Agent | DTP research digests, pattern candidates, Business Brain docs, approved field notes, company filings, industry reports | official/company sources first; reputable industry and analyst sources for pattern sensing; broad search allowed for discovery with evidence limits | business-pattern candidate, transferability note, diagnostic question set, client education seed | public claims, client advice, pricing/offer changes, legal/financial conclusions, autonomous monitoring |
