...
- `dtp practice doctor`
- `dtp practice source-packs validate [--path PATH]`
- `dtp practice source-packs status [--path PATH]`
- `dtp practice source-packs dashboard [--path PATH] [--out PATH]`
...
- `dtp research steward [--limit N]`
- `dtp research source-freshness [--source-id ID] [--note TEXT] [--url URL] [--query TEXT] [--fetch-url] [--search-web]`
