...
| Public company filings and investor materials | primary/company source | SEC EDGAR, annual reports, investor days, official investor relations pages | business-model, capex, distribution, risk, operating-model, and innovation-pattern evidence | business-agent, firm-strategy, pricing, infrastructure, or market-structure event | business-pattern candidate, transferability note |
| Company engineering, product, and operations blogs | official/company source | official company blogs and technical/product posts | how firms explain implementation choices, operating constraints, product bets, and platform strategy | firm innovation, operating-model, or implementation-pattern event | digest, business-pattern candidate |
| AI and workflow company pattern watchlist | official/company plus field-note source | Glean, Granola, Cursor, Lovable, Harvey, Sierra, n8n, Lindy, Gamma, and similar companies Toni flags | study what workflow pain was solved, what pattern is transferable, and what consulting artifact should be built | Toni forwards a company/product signal, asks what can be learned, or a client problem resembles a known pattern | radar item, digest, pattern candidate, diagnostic question, artifact seed |
| Industry associations and trade publications | industry source | sector associations, trade publications, professional bodies | sector-specific operating constraints, buyer language, regulation, capacity, supply chain, and distribution patterns | industry-shift or client-sector event | digest with source limits, pattern candidate |
...
| EIA electricity reports and Today in Energy | primary research | https://www.eia.gov/electricity/reports.php | U.S. electricity demand, data-center load, regional generation and price context | AI infrastructure, data-center, or power-demand event | research digest, source freshness item |
| EPRI data center / electrification research | primary research | https://www.epri.com/ | data-center electricity demand, grid planning, electrification, utility coordination | AI energy or grid-capacity event | research digest, pattern candidate |
| NVIDIA AI infrastructure and technical blog | vendor / official technical docs | https://developer.nvidia.com/blog/ | AI factory architecture, GPU/memory/network/storage constraints, agentic AI infrastructure | NVIDIA/platform architecture event | research digest, source-pack note |
| Memory vendor HBM and AI infrastructure pages | vendor | Micron, Samsung, SK hynix official news/product pages | memory bandwidth, HBM, power efficiency, storage hierarchy, AI supply-chain signals | memory/HBM/AI infrastructure event | research radar item |
| Data center infrastructure trade sources | reputable industry media | Data Center Dynamics, Data Center Frontier, Uptime Institute | siting, grid interconnection, power strategy, cooling, permitting, utility/data-center deals | data-center operations or utility strategy event | research digest with source limits |
| Local/regulatory coverage for xAI Memphis and similar cases | mixed: official/vendor/local/reporting | xAI official pages, EPA/state/local records, AP, DCD, TechCrunch, local Memphis reporting | rapid AI buildout case studies, permitting, community impact, on-site generation, evidence-limit training | xAI/Memphis or similar data-center case event | research pattern candidate with high caution |
