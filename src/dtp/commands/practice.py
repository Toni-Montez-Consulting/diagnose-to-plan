...
REQUIRED_TEMPLATES = (
    ...
    "client-os-bridge-queue.md",
    "client-os-build-task.md",
    "client-os-chain-run.md",
    "client-os-meeting-brief.md",
    "client-os-meeting-notes.md",
    "client-os-pilot-packet.md",
    "client-os-post-meeting-receipt.md",
