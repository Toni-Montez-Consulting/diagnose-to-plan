...
| "Opportunity OS", "relationship system", "warm lead", "relationship map", "referral map", "operator opportunity", "high-trust consulting growth", "consulting CRM", "Notion mirror for opportunities", "research/opportunity Notion mirror" | Opportunity OS V0 | `docs/OPPORTUNITY_OS_V0.md`, `docs/RESEARCH_AND_OPPORTUNITY_NOTION_MIRROR_V0.md`, `practice-os/templates/opportunity-os-record.md` | no raw private relationship ledger in consulting repo; no automated outreach; Notion is mirror only |
