...
- Hosted DTP now has a Phase 0 schema/app-shell scaffold and Phase 0.1 local private UI in `apps/private-dtp/`; the remaining hosted gate is selecting a Supabase environment/operator account, applying the migration, and running live Auth/RLS/import/export smoke tests.
